...
## Product Decision
FINNRI started as a focused MVP, not a broad personal finance suite. The MVP remains effortless AI capture, confirm-first trust, account-linked transactions, and simple actionable insights. The later-phase web dashboard is now active as a big-screen view of the same trusted data and existing backend tools. Bank integrations, statement reconciliation, bulk management, advanced reports, and open-ended AI financial advice remain deferred.
...
- Full-history exports, advanced web reports, and bulk editing
